        ...
        {COLUMNS.map((col) => {
          ...
          return (
            <div key={col.key} style={{
              ...
              background: 'var(--cth-cream-100)', boxShadow: 'inset 0 0 0 1px var(--cth-ink-300), 2px 2px 0 0 var(--cth-ink-300)'
            }}>
              <div style={{
    ...
    <div style={{ position: 'relative', display: 'flex' }}>
      ...
      >
        ...
        <span style={{ flex: 1, minWidth: 0, padding: '6px 18px 6px 7px', display: 'flex', flexDirection: 'column', gap: 2 }}>
          ...
          {assigneeName && (
            <span style={{ fontSize: 13, color: 'var(--cth-ink-500)', fontFamily: 'var(--cth-font-display)' }}>
        ...
        <PixelPanel variant="dialog" title={t('kanban.taskTitle')} noPadding style={{ display: 'flex', flexDirection: 'column', width: '100%', minHeight: 0 }}>
          <div style={{ padding: 14, display: 'flex', flexDirection: 'column', gap: 10, minHeight: 0, overflowY: 'auto' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap' }}>
              ...
              <span style={{ marginLeft: 'auto', fontSize: 13, color: 'var(--cth-ink-500)', fontFamily: 'var(--cth-font-display)' }}>
            ...
            {(task.humanQA?.length ?? 0) > 0 && (
              <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
                <div style={{ fontFamily: 'var(--cth-font-display)', fontSize: 11, color: 'var(--cth-ink-500)' }}>
                  {t('kanban.humanQA')}
                </div>
                {task.humanQA!.map((e, i) => (
                  <div key={i} style={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                    <div style={{
                      ...
                      <span style={{ fontFamily: 'var(--cth-font-display)', fontSize: 11, flexShrink: 0, marginTop: 2 }}>Q</span>
                    ...
                    {e.a ? (
                      <div style={{
                        ...
                        <span style={{ fontFamily: 'var(--cth-font-display)', fontSize: 11, flexShrink: 0, marginTop: 2 }}>A</span>
                        <div style={{ flex: 1, minWidth: 0 }}>
                ...
                {deps.map((d) => {
                  ...
                  return (
                    <div key={d.id} style={{
                      ...
                      <span style={{ width: 8, height: 8, background: dc.accent, flexShrink: 0 }} />
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
              <select
                ...
                style={{
                  ...
                  boxShadow: 'inset 0 0 0 1px var(--cth-ink-300), 2px 2px 0 0 var(--cth-ink-300)', fontFamily: 'var(--cth-font-ui)',
...
const inputStyle: React.CSSProperties = {
  ...
  boxShadow: 'inset 0 0 0 1px var(--cth-ink-100), 2px 2px 0 0 var(--cth-ink-100)', fontFamily: 'var(--cth-font-ui)',
...
const labelStyle: React.CSSProperties = {
  fontFamily: 'var(--cth-font-display)', fontSize: 11, color: 'var(--cth-ink-500)'
};
